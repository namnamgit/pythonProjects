...
deposito_mensal = float(input('Valor do depósito mensal: ')) #update
deposito_mais_juros = deposito_inicial

while contador <= 2:
	deposito_mais_juros = (deposito_mais_juros + deposito_mensal) + ((deposito_mais_juros + deposito_mensal) * juros / 100)
	apenas_juros = deposito_mais_juros - (deposito_inicial + deposito_mensal * contador)
